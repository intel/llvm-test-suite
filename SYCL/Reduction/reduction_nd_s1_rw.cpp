...
int main() {
  ...
  testBoth<class B2, int, ONEAPI::plus<>>(0, 199, 32, 128);
  testBoth<class B3, int, ONEAPI::plus<>>(0, 299, 128, 128);
  ...
  testBoth<class C2, float, std::multiplies<float>>(1, 1.2, 8, 16);
  testBoth<class C3, short, ONEAPI::bit_or<>>(0, 0x3400, 4, 32);
  testBoth<class C4, int, ONEAPI::bit_xor<int>>(0, 0x12340000, 2, 16);
