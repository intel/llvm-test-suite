...
int main() {
  ...
  testBoth<class B2, int, std::multiplies<int>>(1, 99, 4, 64);
  testBoth<class B3, int, ONEAPI::bit_or<int>>(0, 99, 8, 128);
  ...
  testBoth<class C1, float, std::multiplies<float>>(1, 99, 8, 256);
